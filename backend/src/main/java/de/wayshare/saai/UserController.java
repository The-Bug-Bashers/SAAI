...
public class UserController {
  ...
  public ResponseEntity<Map<String, String>> updateUserExperience(
      @PathVariable String username, @RequestBody Map<String, String> requestBody) {
    String password = requestBody.get("password");
  ...
  public ResponseEntity<Map<String, String>> updateUserTelephoneNumber(
      @PathVariable String username, @RequestBody Map<String, String> requestBody) {
    String password = requestBody.get("password");
