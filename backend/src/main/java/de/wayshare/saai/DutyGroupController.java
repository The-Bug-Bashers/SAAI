...
public class DutyGroupController {
  ...
  @Autowired private DutyGroupService dutyGroupService;
  ...
  @GetMapping("/{id}")
  public ResponseEntity<DutyGroup> getDutyGroupById(
      @PathVariable Long id, @RequestParam("password") String password) {
  ...
  public ResponseEntity<DutyGroup> addDutyGroup(@RequestBody Map<String, Object> requestBody) {
    ...
    dutyGroup.setFridayDutyEnd(
        requestBody.get("fridayDutyEnd") != null
  ...
  @PutMapping("/{id}")
  public ResponseEntity<DutyGroup> updateDutyGroup(
  ...
  @DeleteMapping("/{id}")
  public ResponseEntity<Void> deleteDutyGroup(
      @PathVariable Long id, @RequestParam("password") String password) {
